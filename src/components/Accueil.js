...
export default function Accueil() {
  ...
  const [secondPage, setSecondPage] = useState(Math.floor((200 - 1) / cardsPerPage));
  ...
  return (
    <div className='full-page-div'>
      ...
      <div class="centered-div">
        <h2 class="impact-text">Notre équipe, composée de KONE Aboubakar, TONDEUR Sophie, VERSAYO Franklin et TEST Morgane, a développé en seulement 4 jours une
    ...
    <div class="centered-div">
        <h2 class="impact-text">CARTE EXCLUSIVE (creer par les ADMIN)</h2>
    </div>  
    <div className="article-container">
